...
reporting, supported host choices, latest supported NI LabVIEW Docker image
selection without a Docker bitness choice, and fail-closed unsupported
selection guidance.
