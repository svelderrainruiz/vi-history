...
| TEST-UNIT-RSSELECT-003 | VHS-REQ-545 | Prove Docker selection remains bounded to LabVIEW 2026 x64 and fails closed for unsupported Docker years or bitness. |
